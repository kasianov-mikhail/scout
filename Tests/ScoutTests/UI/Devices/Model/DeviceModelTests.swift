...
struct DeviceModelTests {
    @Test("Maps known hardware identifiers to marketing names", arguments: [
    ...
    @Test("Falls back to the raw identifier for unknown or malformed values", arguments: [
        "iPhone99,9",
        "iphone 18.4",
        "arm64",
        "",
    ...
    @Test("Picks a symbol per device family", arguments: [
        ("iPhone16,1", "iphone"),
        ("iPad14,1", "ipad"),
        ("Watch7,5", "applewatch"),
        ("iPod9,1", "iphone"),
